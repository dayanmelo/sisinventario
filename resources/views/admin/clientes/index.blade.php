...
@section('content_header')
    <div class="container-fluid">
        <div class="row mb-2">
            <div class="col-sm-6">
                <h1><b>Clientes</b>/Listado de Clientes</h1>
            </div>
            <div class="col-sm-6">
                <ol class="breadcrumb float-sm-right">
                    <a href="{{url('/admin/clientes/create')}}" class="btn btn-sm btn-primary">
                        Crear nuevo
                    </a>
                </ol>
            </div>
                        ...
                        @foreach($clientes as $cliente)
                            <tr>
                                ...
                                <td style="text-align: center">
                                    <div class="btn-group">
                                        <a href="{{url('/admin/clientes',$cliente->id)}}" class="btn btn-info"><i class="fas fa-w fa-eye"></i></a>
                                        <a href="{{url('/admin/clientes/'.$cliente->id.'/edit')}}" class="btn btn-success"><i class="fas fa-pencil-alt"></i></a>
                                            ...
                                            function preguntar{{$cliente->id}}(event){
                                                ...
                                                Swal.fire({
                                                    ...
                                                    if (result.isConfirmed) {
                                                        ...
                                                        Swal.fire({
                                                            position: "center",
                                                            title: "Se elimino el cliente exitosamente",
