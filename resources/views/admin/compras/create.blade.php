...
@section('content_header')
    <div class="container-fluid">
        <div class="row mb-2">
            <div class="col-sm-6">
                <h1><b>Compras</b>/Crear Compra</h1>
            </div>
            <div class="col-sm-6">
                                            ...
                                            @foreach($tmp_compras as $tmp_compra)
                                                ...
                                                <tr>
                                                    ...
                                                    <td style="text-align: center">
                                                            <button type="button" class="btn btn-danger btn-sm delete-btn" data-id="{{$tmp_compra->id}}"><i class="far fa-times-circle"></i></button>
                                                    </td>
                                                </tr>
                                                @php
                                                    $total += $costo;
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" value="{{'FACTURA: '.old('comprobante')}}" id="comprobante" name="comprobante">
                                            @error('comprobante')
                                            <small style="color: red">{{$message}}</small>
                                            @enderror
                                        </div>
